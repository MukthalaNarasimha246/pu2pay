...
import json
import os
from get_db_name_from_token import get_psycopg2_connection
from paddleocr import PaddleOCR
from pu2pay_backend.invoice import insert_invoice_data
import torch
...
def Image_to_JSON(image_name, extract_text, pdf_ref_id, db_name):
...
#   "content": f'Extract the following fields and groupd them into the following 1. Invoice Details, 2. Bill_to, 3. Ship_to, 4. Line Items, 5.Inovice Summary, others", {extract_text}',
    ...
    insert_invoice_duplicate_check(results,pdf_ref_id, db_name)
...
def insert_invoice_duplicate_check(data, pdf_ref_id, db_name):
